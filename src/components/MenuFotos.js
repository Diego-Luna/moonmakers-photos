      ...
      <div className="menuFotos-elements">
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateFotos.explorar.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateFotos.compartido.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
      ...
      <div className="menuFotos-elements">
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateFotos.favoritos.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateFotos.albumes.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateFotos.archivo.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateFotos.papelera.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
