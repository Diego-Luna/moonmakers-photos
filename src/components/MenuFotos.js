  ...
  return (
    <div className="menuFotos">
      <div className="menuFotos-elements">
        <BotomStateGray
          varState={stateBotons.fotos.value}
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateBotons.fotos.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
        ...
        <BotomStateGray
          varState={stateBotons.explorar.value}
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateBotons.explorar.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
        ...
        <BotomStateGray
          varState={stateBotons.compartido.value}
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateBotons.compartido.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
      ...
      <div className="menuFotos-elements">
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateBotons.favoritos.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateBotons.albumes.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
        ...
        <BotomStateGray
          varState={stateBotons.utilidades.value}
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateBotons.utilidades.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateBotons.archivo.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateBotons.papelera.value ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
