      ...
      <div className="menuFotos-elements">
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateBotons.fotos ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateBotons.explorar ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateBotons.compartido ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
      ...
      <div className="menuFotos-elements">
        ...
        >
          <svg
            width="24px"
            height="24px"
            className={` ${stateBotons.utilidades ? "svg-blue" : "svg-gray"} `}
            viewBox="0 0 24 24"
          >
