  ...
  return (
    <div className="container-secction-fotos">
      <svg
        ...
        fill="none"
      >
        <path d="M117 26H15v102h102V26z" fill="#D2E3FC" />
        <path
      ...
      <h3 className="container-secction-fotos_h3">No hay favoritos</h3>
      <p className="container-secction-fotos_p">
        Las fotos y los videos que marcas como favoritos se muestran aqui
      </p>
    </div>
  );
}
