  ...
  return (
    <div className="container-secction-fotos">
      <div className="fotos-suptitle-container">
        <h2 className="fotos-suptitle">Archivo</h2>
      </div>
      <svg
      ...
      <p className="container-secction-fotos_p">
        Los elementos archivados se guardarán aquí. Se <br /> seguirán mostrando
        en los álbumes y los resultados <br /> de busqueda
      </p>
    </div>
  );
}
