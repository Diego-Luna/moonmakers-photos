      ...
      <div className="center-all" >
        <div>
          ...
          >
            ...
            />
            <path
              d="M139.664 124l-46.112-14.76-24.283 19.644 46.113 14.76L139.664 124z"
              fill="#DADCE0"
            />
            <path
              d="M139.664 118l-46.112-14.76-24.283 19.644 46.113 14.76L139.664 118z"
              fill="#E8EAED"
            />
            <path
              d="M139.664 112L93.552 97.24l-24.283 19.644 46.113 14.76L139.664 112z"
              fill="#F1F3F4"
            />
            <path
              d="M258.664 164l-46.112-14.76-24.283 19.644 46.113 14.76L258.664 164z"
              fill="#DADCE0"
            />
            <path
              d="M258.664 158l-46.112-14.76-24.283 19.644 46.113 14.76L258.664 158z"
              fill="#E8EAED"
            />
            <path
              d="M258.664 152l-46.112-14.76-24.283 19.644 46.113 14.76L258.664 152z"
              fill="#F1F3F4"
            />
            <path
              d="M200.664 142l-46.112-14.76-24.283 19.644 46.113 14.76L200.664 142z"
              fill="#DADCE0"
            />
            <path
              d="M200.664 136l-46.112-14.76-24.283 19.644 46.113 14.76L200.664 136z"
              fill="#E8EAED"
            />
            <path
              d="M200.664 130l-46.112-14.76-24.283 19.644 46.113 14.76L200.664 130z"
              fill="#F1F3F4"
            />
            <path
              fillRule="evenodd"
            ...
            <g mask="url(#a)" fillRule="evenodd" clipRule="evenodd">
              ...
              />
              <path
                d="M239.841 143.348l-2.325.076.038-1.355-3.876.127-.076 2.711-3.101.102.074-2.609s-.118-2.13-2.265-2.059c-2.147.07-2.385 2.211-2.385 2.211l-.036 1.255-2.325.076.038-1.356-4.651.153-.038 1.356-4.651.153.077-2.712-3.875.128.057-2.034-3.875.128-.019.677-6.201.204-.316 11.154 48.056-1.58.393-13.865-8.526.28-.192 6.779z"
                fill="#137333"
              />
            </g>
            <path
            ...
            <g mask="url(#b)" fillRule="evenodd" clipRule="evenodd">
              ...
              />
              <path
                d="M89.637 101.422a2.66 2.66 0 00-3.038-2.726 4.175 4.175 0 00-4.44-4.605 4.163 4.163 0 00-3.123-2.43 4.182 4.182 0 00-4.859 4.426 2.667 2.667 0 00-3.356 2.125l-.006.053 18.822 3.157z"
                fill="url(#paint4_linear)"
              />
              <path
                d="M84.45 100.395a2.663 2.663 0 014.034-.627 4.18 4.18 0 016.237-1.436A4.168 4.168 0 0198.664 98a4.177 4.177 0 011.655 6.357 2.664 2.664 0 011.651 3.61c-.007.017-.016.031-.023.047l-17.497-7.619z"
                fill="url(#paint5_linear)"
              />
              <path
                opacity=".7"
                d="M93.658 91.327c2.452.727 5.033-.68 5.765-3.14.733-2.46-.66-5.043-3.112-5.77-2.452-.726-5.033.68-5.766 3.14-.732 2.46.661 5.044 3.113 5.77z"
                fill="url(#paint6_linear)"
              />
              <path
                d="M86.627 110.796l16.833-11.97 11.145 17.349-27.978-5.379z"
                fill="url(#paint7_linear)"
              />
              <path
                d="M67.771 109.346l20.088-17.65 13.745 25.956-33.833-8.306z"
                fill="#6397F6"
              />
            </g>
            <path
            ...
            <g mask="url(#c)" fillRule="evenodd" clipRule="evenodd">
              ...
              />
              <path
                d="M68.217 108.976l8.579-54.481 54.398 8.444-8.578 54.481-54.399-8.444z"
                fill="#8AB4F8"
              />
              <path
                d="M107.01 95.126c.116-6.794-2.279-12.632-7.186-13.715-5.657-1.247-11.734 4.38-13.53 12.373 0 0-.34 2.492.773 4.347 1.57 1.868-2.342 3.591-3.693 4.466-1.812 1.172-1.297 6.469-1.297 6.469l21.836 4.816s1.21-5.251-.221-6.804c-1.047-1.136 1.349-3.649 2.148-5.721.798-2.071 1.152-5.194 1.17-6.23z"
                fill="#185ABC"
              />
              <path
                d="M108.793 114.957c-2.112-2.587-6.336-7.25-14.803-9.121-8.466-1.87-13.712.398-16.374 2.233l31.177 6.888z"
                fill="#D2E3FC"
              />
              <path
                d="M91.841 98.995c-1.167-1.658 8.519 1.133 8.519 1.133-1.224-.27-2.356 7.034-2.356 7.034s.286 3.055-4.128 2.082c-4.415-.974-3.366-3.648-3.366-3.648s2.498-4.942 1.331-6.6z"
                fill="#4285F4"
              />
              <path
                d="M91.841 98.995c-1.167-1.658 8.519 1.133 8.519 1.133-1.224-.27-2.356 7.034-2.356 7.034s.286 3.055-4.128 2.082c0 0-.868-8.59-2.035-10.249z"
                fill="#1A73E8"
              />
              <path
                d="M94.085 101.753c.403.23.836.4 1.297.502 1.162.256 2.355.045 3.479-.538v-.002.002l.207-.112c2.066-1.165 3.873-3.588 4.787-6.665 0 0-.74-1.944-2.578-2.794-1.837-.85-8.207-4.172-8.468-5.457 0 0 .008-.014-.01.014-.783 1.249-1.32 2.597-1.688 4.234-1.055 4.694.213 9.238 2.974 10.816l.163.086-.163-.086z"
                fill="#4285F4"
              />
            </g>
            <defs>
          ...
          <p className="container-secction-fotos_p">
            Estamos organizando tus fotos para que las encuentres más
            rápidamente
          </p>
        </div>
      </div>
